...
#define brisbane_profile            (1 << 6)
#define brisbane_eager              (1 << 7)
...
#define brisbane_device_profile     (1 << 6)
#define brisbane_device_eager       (1 << 7)
#define brisbane_device_random      (1 << 8)
#define brisbane_device_any         (1 << 9)
#define brisbane_device_all         (1 << 10)
