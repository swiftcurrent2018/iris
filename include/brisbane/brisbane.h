...
#define brisbane_eager              (1 << 8)
#define brisbane_random             (1 << 9)
#define brisbane_any                (1 << 10)
#define brisbane_all                (1 << 11)

#define brisbane_device_default     (1 << 0)
#define brisbane_device_cpu         (1 << 1)
#define brisbane_device_nvidia      (1 << 2)
#define brisbane_device_amd         (1 << 3)
#define brisbane_device_gpu         (brisbane_device_nvidia | brisbane_device_amd)
#define brisbane_device_phi         (1 << 4)
#define brisbane_device_fpga        (1 << 5)
#define brisbane_device_data        (1 << 6)
#define brisbane_device_profile     (1 << 7)
#define brisbane_device_eager       (1 << 8)
#define brisbane_device_random      (1 << 9)
#define brisbane_device_any         (1 << 10)
#define brisbane_device_all         (1 << 11)
