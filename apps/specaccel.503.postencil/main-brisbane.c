...
int main(int argc, char** argv) {
  ...
  */
  ...
  brisbane_mem mem_A0;
  brisbane_mem mem_Anext;
  brisbane_mem_create(size * sizeof(float), &mem_A0);
  brisbane_mem_create(size * sizeof(float), &mem_Anext);

  brisbane_task task0;
  brisbane_task_create(&task0);
  brisbane_task_h2d(task0, mem_A0, 0, size * sizeof(float), h_A0);
  brisbane_task_h2d(task0, mem_Anext, 0, size * sizeof(float), h_Anext);
  ...
  brisbane_kernel_setarg(kernel_stencil, 5, sizeof(int), &ny);
  brisbane_kernel_setarg(kernel_stencil, 6, sizeof(int), &nz);
...
//      brisbane_task_present(task1, mem_A0, 0, size * sizeof(float), h_A0);
//      brisbane_task_present(task1, mem_Anext, 0, size * sizeof(float), h_Anext);
      size_t kernel_stencil_off[3] = { 0, 0, 0 };
  ...
  brisbane_task_d2h(task2, mem_Anext, 0, size * sizeof(float), h_Anext);
