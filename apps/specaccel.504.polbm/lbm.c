...
void LBM_allocateGrid( double** ptr, double ** org_ptr ) {
	...
	*ptr += margin;
    ...
    printf("[%s:%d] GRID_SIZE[%lu] size[%lu] gridSize[%lu]\n", __FILE__, __LINE__, GRID_SIZE, size, gridSize);
}
