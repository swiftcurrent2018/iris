...
#include <Vector.hpp>
#include <Vector_functions-brisbane.hpp>
            ...
            VectorType& y)
{
  	...
  	typedef typename MatrixType::LocalOrdinalType LocalOrdinalType;
        ...
        brisbane_mem mem_Acols;
        brisbane_mem mem_Arowoffsets;
        brisbane_mem mem_Acoefs;
        brisbane_mem mem_xcoefs;
        brisbane_mem mem_ycoefs;
        brisbane_mem_create(sizeof(int) * A.packed_cols.size(), &mem_Acols);
        brisbane_mem_create(sizeof(int) * A.row_offsets.size(), &mem_Arowoffsets);
        brisbane_mem_create(sizeof(double) * A.packed_coefs.size(), &mem_Acoefs);
        brisbane_mem_create(sizeof(double) * x.coefs.size(), &mem_xcoefs);
        brisbane_mem_create(sizeof(double) * y.coefs.size(), &mem_ycoefs);

        size_t kernel_matvec_std_operator_off[1] = { 0 };
        size_t kernel_matvec_std_operator_idx[1] = { rows_size };
        brisbane_kernel kernel_matvec_std_operator;
        brisbane_kernel_create("matvec_std_operator", &kernel_matvec_std_operator);
        brisbane_kernel_setmem(kernel_matvec_std_operator, 0, mem_Arowoffsets, brisbane_r);
        brisbane_kernel_setmem(kernel_matvec_std_operator, 1, mem_Acols, brisbane_r);
        brisbane_kernel_setmem(kernel_matvec_std_operator, 2, mem_Acoefs, brisbane_r);
        brisbane_kernel_setmem(kernel_matvec_std_operator, 3, mem_xcoefs, brisbane_r);
        brisbane_kernel_setmem(kernel_matvec_std_operator, 4, mem_ycoefs, brisbane_rw);
        brisbane_kernel_setarg(kernel_matvec_std_operator, 5, sizeof(double), (void*) &beta);

        brisbane_task task0;
        brisbane_task_create(&task0);
        brisbane_task_h2d_full(task0, mem_Arowoffsets, (void*) Arowoffsets);
        brisbane_task_h2d_full(task0, mem_Acols, (void*) Acols);
        brisbane_task_h2d_full(task0, mem_Acoefs, (void*) Acoefs);
        brisbane_task_h2d_full(task0, mem_xcoefs, (void*) xcoefs);
        brisbane_task_h2d_full(task0, mem_ycoefs, (void*) ycoefs);
        brisbane_task_kernel(task0, kernel_matvec_std_operator, 1, kernel_matvec_std_operator_off, kernel_matvec_std_operator_idx);
        ...
        brisbane_mem_release(mem_Acols);
        brisbane_mem_release(mem_Arowoffsets);
        brisbane_mem_release(mem_Acoefs);
